...
<div class="sidebar">
  ...
  <nav>
    <ul class="menu">
      ...
      <li><a class="active" href="#do"><i class="fas fa-file-lines"></i>Dashboard Outsource</a></li>
    ...
    <div style="display: flex; flex-direction: column; gap: 6px;">
      ...
      <div style="display: flex; align-items: center; gap: 6px;">
        <div class="breadcrumb-row">
          ...
          <a href="{{ url()->current() }}" class="breadcrumb-text">Dashboard Outsource</a>
        </div> 
      </div>
      <h2 class="page-title">Dashboard Outsource</h2>
    </div>
